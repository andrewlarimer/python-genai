...
class AsyncLive(_api_module.BaseModule):
  ...
  async def connect(
    ...
    if self._api_client.api_key:
      ...
      request_dict = {}
      live_converters._LiveConnectConfig_to_mldev(
          api_client=self._api_client,
          from_object=parameter_model.model_dump(exclude_none=True),
          parent_object=request_dict,
      )
      ...
      live_converters._LiveConnectConfig_to_vertex(
          api_client=self._api_client,
          from_object=parameter_model.model_dump(exclude_none=True),
          parent_object=request_dict,
      )
